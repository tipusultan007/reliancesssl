...
@section('content')
    <div class="container-fluid">
        ...
        <!-- end page title -->
@php
$savings = \App\Models\DailySavings::get();
@endphp
        <div class="row">
            <div class="col-md-4">
        ...
        <form class="my-3 " action="{{ route('import.daily') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="input-group w-50 mx-auto">
                <input type="file" name="csv_file" class="form-control" accept=".csv">
                <button type="submit" class="btn btn-success">Import CSV</button>
            </div>
            <p class="text-center"><a href="{{asset('daily.csv')}}" download="daily.csv">নমুনা ফাইল ডাউনলোড করুন</a></p>
        </form>
        <div class="row">
            <div class="col-xl-12">
