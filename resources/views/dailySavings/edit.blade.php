        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">দৈনিক সঞ্চয় সম্পাদনা</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" action="{{ route('daily-savings.update',$savings->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        <div class="col-xl-12 col-sm-12 mb-2">
                                            ...
                                            <select class="form-control select2" id="member_id" name="member_id" data-placeholder="Select" data-toggle="select2">
                                                ...
                                                @foreach($members as $item)
                                                    <option value="{{ $item->id }}" {{ $item->id==$savings->member_id?"selected":"" }}>{{ $item->name }} - {{ $item->father_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-sm-12 mb-2">
                                            <div class="form-group " >
                                                <label class="form-label" for="date"> তারিখ </label>
                                                    <input id="date" class="form-control " name="date" type="date" value="{{ $savings->date }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label" for="">জমা</label>
                                            <input type="number" class="form-control" name="deposit" value="{{ $savings->deposit }}">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label" for="">উত্তোলন</label>
                                            <input type="number" class="form-control" name="withdraw" value="{{ $savings->withdraw }}">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label" for="">লভ্যাংশ</label>
                                            <input type="number" class="form-control" name="profit" value="{{ $savings->profit }}">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label" for="">বোনাস</label>
                                            <input type="number" class="form-control" name="bonus" value="{{ $savings->bonus }}">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label" for="">অবশিষ্ট জমা</label>
                                            <input type="number" class="form-control" name="total" value="{{ $savings->total }}">
                                        </div>
                                        <div class="col-xl-6 col-sm-12 mb-2">
                                            <div class="form-group">
                                                <label class="form-label" for="notes">মন্তব্য</label>
                                                <input type="text" class="form-control" id="notes" value="{{ $savings->notes }}" name="notes">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{--@php
$nominee = \App\Models\Nominee::where('account_no',$savings->account_no)->first();
 @endphp--}}
                            <h4>নমিনী -০১</h4>
                            <div class="row mb-3 nominee">
                                ...
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="nominee_mobile" name="nominee_mobile" value="{{ $nominee->nominee_mobile??"" }}">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-preview my-2">
                                            @if($nominee->nominee_nid)
                                                <img height="80" src="{{ asset('storage/'.$nominee->nominee_nid) }}" alt="">
                                            @else
                            ...
                            <div class="row mb-3 nominee">
                                ...
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="nominee_mobile1" name="nominee_mobile1" value="{{ $nominee->nominee_mobile1??'' }}">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-preview my-2">
                                            @if($nominee->nominee_nid1)
                                                <img height="80" src="{{ asset('storage/'.$nominee->nominee_nid1) }}" alt="">
                                            @else
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.error)
                    {
                        ...
                        window.location.href = "{{ url('daily-savings') }}";
                        $("form").trigger('reset');
                    }
                    //console.log(data)
                    //$(".spinner").hide();
...
<td><b> দৈনিক ঋনঃ </b></td>  <td>${data.daily_loans}</td>
        ...
        $("#account_no").on("change", function () {
            ...
            if ($(this).val() != "") {
                $("#result").empty();
                $.ajax({
                    url: "{{ url('existSavingAccount') }}/" + account_digit,
                    success: function (data) {
                        console.log(data)
                        if (data == 1) {
