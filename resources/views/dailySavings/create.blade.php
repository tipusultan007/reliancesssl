        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">নতুন দৈনিক সঞ্চয়</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        @php
                            $dailySavings = \App\Models\DailySavings::latest('account_no')->first();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-sm-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="account_no" min="0"
                                                       value="{{ $number }}" name="account_no">
                                                <div id="result"></div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-sm-12 mb-2">
                            ...
                            <div class="row mb-3 nominee">
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nominee_name1" name="nominee_name1"
                                               value="">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-sm-12 mt-2">
                                ...
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="nominee_percentage1"
                                               name="nominee_percentage1" value="">
                                    </div>
                                </div>
                            </div>
