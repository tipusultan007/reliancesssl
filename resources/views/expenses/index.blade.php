        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"> সকল ব্যয়</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        <form id="expenseForm">
                            ...
                            <div class="form-group mb-2">
                                <label for="" class="form-label">ব্যয়ের ধরনঃ</label>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input id="date" name="date" class="form-control" type="date" value="{{ date('Y-m-d') }}">
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">ব্যয় আপডেট ফরম</h5>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $("#submit").on("click", function () {
            ...
            var formData = $("#expenseForm").serializeArray();
        ...
        $(".update").on("click",function () {
            ...
            var $caption = $this.html();// We store the html content of the submit button
            var formData = $("#expenseEditForm").serializeArray();
            var id = $("#expenseEditForm input[name='id']").val();
