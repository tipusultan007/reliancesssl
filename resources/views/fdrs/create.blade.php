        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        @php
                            $fdrs = \App\Models\Fdr::latest('account_no')->first();
                            if ($fdrs)
                            {
                                $str = $fdrs->account_no;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-sm-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="fdr_amount" name="fdr_amount">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-sm-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <select name="type" id="type" class="form-select select2">
                                                    <option value="monthly">মাসিক মুনাফা ভিত্তিক</option>
                                                    <option value="interim">কালান্তিক মুনাফা ভিত্তিক</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-sm-12 mb-2 monthly_profit_rate">
                                            <div class="form-group">
                                                <label class="form-label" for="profit_rate">মুনাফার হার(%)</label>
                                                <input type="number" class="form-control" id="profit_rate" name="profit_rate">
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-3 nominee">
                                ...
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group" >
                                      ...
                                      <input id="birth_date1" name="birth_date" class="form-control" type="date">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
                                ...
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group" >
                                        <label class="form-label" for="birth_date2">জন্ম তারিখ </label>
                                            <input id="birth_date2" name="birth_date1" class="form-control" type="date">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-sm-12 mt-2">
                                    <div class="form-group">
