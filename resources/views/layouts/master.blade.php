...
<head>
    ...
    <link href="{{asset('assets/vendor/lightbox/css/lightbox.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('assets/jquery-ui.min.css')}}" rel="stylesheet" type="text/css" />
