                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" >
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 mb-2">
                                            ...
                                            <select name="savings_id" id="account_no" class="form-control form-control-sm select2" data-allow-clear="on" data-placeholder="Select" data-toggle="select2">
                                                ...
                                                @foreach($savings as $item)
                                                    <option value="{{ $item->id }}">{{ $item->account_no }} - {{ $item->member->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                            <label class="form-label-sm" for="loan_amount">ঋণের পরিমাণ </label>
                                                <input type="number" class="form-control form-control-sm" id="loan_amount" name="loan_amount" value="">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                            <label class="form-label-sm" for="interest_rate">লভ্যাশের হার </label>
                                            <div class="position-relative">
                                                <input type="number" class="form-control form-control-sm" id="interest_rate" name="interest_rate" value="">
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            ...
                                            <input type="number" class="form-control form-control-sm" id="per_installment" name="per_installment" value="" readonly>
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            <label class="form-label-sm" for="notes">মন্তব্য  </label>
                                                <input type="text" class="form-control form-control-sm" id="notes" name="notes" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-xl-6 mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="bank_name" id="bank_name">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="account_holder" id="account_holder">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                            <label for="bank_ac_number" class="form-label-sm">ব্যাংকের হিসাব নম্বর</label>
                                            <input type="text" class="form-control form-control-sm" name="bank_ac_number" id="bank_ac_number">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                            <label for="cheque_number" class="form-label-sm">চেক নম্বর</label>
                                            <input type="number" class="form-control form-control-sm" name="cheque_number" id="cheque_number">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="name1" name="name1">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            <label for="g_mobile1" class="form-label-sm">হিসাব নং</label>
                                            <input type="text" class="form-control form-control-sm" id="g_mobile1" name="g_mobile1">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            <label for="g_mobile2" class="form-label-sm">হিসাব নং</label>
                                            <input type="text" class="form-control form-control-sm" id="g_mobile2" name="g_mobile2">
                                        </div>
                                        <div class="col-xl-6 mb-2">
                            ...
                            <button class="btn btn-primary" type="button" id="btn-submit">সাবমিট করুন</button>
                        </form>
