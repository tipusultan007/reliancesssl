...
class ExpenseController extends Controller
{
    ...
    public function dataExpenses(Request $request)
    {
        ...
        if(empty($request->input('search.value')))
        {
            ...
            $posts =  Expense::where('description','LIKE',"%{$search}%")
                ->offset($start)
                ->limit($limit)
                ->orderBy('date','desc')
                ->get();
    ...
    public function store(Request $request)
    {
        ...
        $trx_cat_id = TransactionCategory::where('expense_category_id',$income->category_id)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        $expense->update($data);
        $trx = Transaction::where('trx_id',$expense->trx_id)->first();
        $trx->amount = $expense->amount;
        $trx->date = $expense->date;
        $trx->save();
    }
